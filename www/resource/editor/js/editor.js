...
$(function(){
    ...
    if(isIE6 || isIE7 || isIE8){
        ...
        window.onload = function() {
            ...
            var icons = {
                'icons-wangEditor-link' : '&#xe800;',
                'icons-wangEditor-unlink' : '&#xe801;',
                'icons-wangEditor-code' : '&#xe802;',
                'icons-wangEditor-cancel': '&#xe803;',
                'icons-wangEditor-terminal':'&#xe804;',
                'icons-wangEditor-angle-down':'&#xe805;',
                'icons-wangEditor-font':'&#xe806;',
                'icons-wangEditor-bold':'&#xe807;',
                'icons-wangEditor-italic':'&#xe808;',
                'icons-wangEditor-header':'&#xe809;',
                'icons-wangEditor-align-left':'&#xe80a;',
                'icons-wangEditor-align-center':'&#xe80b;',
                'icons-wangEditor-align-right':'&#xe80c;',
                'icons-wangEditor-list-bullet':'&#xe80d;',
                'icons-wangEditor-indent-left':'&#xe80e;',
                'icons-wangEditor-indent-right':'&#xe80f;',
                'icons-wangEditor-list-numbered':'&#xe810;',
                'icons-wangEditor-underline':'&#xe811;',
                'icons-wangEditor-table':'&#xe812;',
                'icons-wangEditor-eraser':'&#xe813;',
                'icons-wangEditor-text-height':'&#xe814;',
                'icons-wangEditor-brush':'&#xe815;',
                'icons-wangEditor-pencil':'&#xe816;',
                'icons-wangEditor-minus':'&#xe817;',
                'icons-wangEditor-picture':'&#xe818;',
                'icons-wangEditor-file-image':'&#xe819;',
                'icons-wangEditor-cw':'&#xe81a;',
                'icons-wangEditor-ccw':'&#xe81b;',
                'icons-wangEditor-music':'&#xe911;',
                'icons-wangEditor-play':'&#xe912;',
                'icons-wangEditor-location':'&#xe947;',
                'icons-wangEditor-happy':'&#xe9df;',
                'icons-wangEditor-sigma':'&#xea67',
                'icons-wangEditor-enlarge2':'&#xe98b;',
                'icons-wangEditor-shrink2':'&#xe98c;',
                'icons-wangEditor-newspaper':'&#xe904;',
                'icons-wangEditor-camera':'&#xe90f;',
                'icons-wangEditor-video-camera':'&#xe914;',
                'icons-wangEditor-file-zip':'&#xe92b;',
                'icons-wangEditor-stack':'&#xe92e;',
                'icons-wangEditor-credit-card':'&#xe93f;',
                'icons-wangEditor-address-book':'&#xe944;',
                'icons-wangEditor-envelop':'&#xe945;',
                'icons-wangEditor-drawer':'&#xe95c;',
                'icons-wangEditor-download':'&#xe960;',
                'icons-wangEditor-upload':'&#xe961;',
                'icons-wangEditor-lock':'&#xe98f;',
                'icons-wangEditor-unlocked':'&#xe990;',
                'icons-wangEditor-wrench':'&#xe991;',
                'icons-wangEditor-eye':'&#xe9ce;',
                'icons-wangEditor-eye-blocked':'&#xe9d1;',
                'icons-wangEditor-command':'&#xea4e;',
                'icons-wangEditor-font2':'&#xea5c;',
                'icons-wangEditor-libreoffice':'&#xeade;',
                'icons-wangEditor-quotes-left':'&#xe977;',
                'icons-wangEditor-strikethrough':'&#xea65;'
            };
            ...
            $('.wangEditor-container i').each(function(){
                var elem = this,
                    ...
                    matchs = className.match(/icons-wangEditor-[^\s'"]+/);
                if (matchs) {
...
$.extend($E, {
    ...
    'htmlTemplates': {
        //删除table,img的按钮
        'elemDeleteBtn': '<a href="#" class="wangEditor-elemDeleteBtn"><i class="icons-wangEditor-cancel"></i></a>',
        ...
        //下拉按钮右侧的小三角
        'btnAngleDown': '<i class="icons-wangEditor-angle-down" style="margin-left:3px;"></i>',
        //btn tooltip
        ...
        'modalHeader': '<div class="wangEditor-modal-header clearfix">' + 
                            '<a href="#" commandName="close" class="wangEditor-modal-header-close"><i class="icons-wangEditor-cancel"></i></a>' + 
                            '<b>{title}</b>' + 
...
'bold': {
    ...
    'cssClass':'icons-wangEditor-bold',
    'command': 'bold',
...
'underline': {
    ...
    'type': 'btn',
    'hotKey': 'ctrl + u',
    'cssClass':'icons-wangEditor-underline',
    'command': 'underline '
},
'italic': {
    ...
    'type': 'btn',
    'hotKey': 'ctrl + i',
    'cssClass':'icons-wangEditor-italic',
    'command': 'italic '
},
'removeFormat': {
    'title': langMenus.removeFormat.title,
    'type': 'btn',
    'cssClass':'icons-wangEditor-eraser',
...
//     'type': 'btn',
//     'hotKey': 'ctrl,shift + i',
//     'cssClass':'icons-wangEditor-indent-right',
//     'command': 'indent'
// },
// 'outdent': {
//     'title': langMenus.outdent.title,
//     'type': 'btn',
//     'cssClass':'icons-wangEditor-indent-left',
//     'command': 'outdent'
// }, 
'unLink': {
    'title': langMenus.unLink.title,
    'type': 'btn',
    'cssClass':'icons-wangEditor-unlink',
    'command': 'unLink ' 
},
'insertHr': {
    'title': langMenus.insertHr.title,
    'type': 'btn',
    'cssClass':'icons-wangEditor-minus',
    'command': 'InsertHorizontalRule' 
},
'strikethrough':{
    'title': langMenus.strikethrough.title,
    'type': 'btn',
    'cssClass':'icons-wangEditor-strikethrough',
    'command': 'StrikeThrough'
},
'blockquote': {
    'title': langMenus.blockquote.title,
    'type': 'btn',
    'cssClass':'icons-wangEditor-quotes-left',
    'command': 'formatBlock',
...
'justify': {
    ...
    'type': 'dropMenu',
    'cssClass':'icons-wangEditor-align-left',
    'dropMenu': function(){
        var arr = [],
            ...
            data = [
                {
                    ...
                    'txt': '<i class="icons-wangEditor-align-left"> ' + langMenus.justify.left.title + '</i>'
                },{
                    //居中
                    'commandName': 'JustifyCenter',
                    'txt': '<i class="icons-wangEditor-align-center"> ' + langMenus.justify.center.title + '</i>'
                },{
                    //右对齐
                    'commandName': 'JustifyRight',
                    'txt': '<i class="icons-wangEditor-align-right"> ' + langMenus.justify.right.title + '</i>'
                }
            ];
...
'list': {
    ...
    'type': 'dropMenu',
    'cssClass':'icons-wangEditor-list-bullet',
    'dropMenu': function () {
        var arr = [],
            temp = '<li><a href="#" customCommandName="${command}">${txt}</a></li>',
            $ul,
            ...
            data = [
                {
                    ...
                    'txt': '<i class="icons-wangEditor-list-bullet"> ' + langMenus.list.unOrdered.title + '</i>'
                },{
                    //有序列表
                    'commandName': 'InsertOrderedList',
                    'txt': '<i class="icons-wangEditor-list-numbered"> ' + langMenus.list.unOrdered.title + '</i>'
                }
            ];
...
'fontFamily': {
    ...
    'type': 'dropMenu',
    'cssClass': 'icons-wangEditor-font2',
    'command': 'fontName ', 
    'dropMenu': function(){
        var arr = [],
...
'fontSize': {
    ...
    'type': 'dropMenu',
    'cssClass': 'icons-wangEditor-text-height',
    'command': 'fontSize',
    'dropMenu': function () {
        var arr = [],
            //注意，此处commandValue必填项，否则程序不会跟踪
...
'setHead': {
    ...
    'type': 'dropMenu', 
    'cssClass':'icons-wangEditor-header',
    'command': 'formatBlock ',
    'dropMenu': function(){
...
'foreColor': {
    ...
    'type': 'dropPanel',
    'cssClass': 'icons-wangEditor-pencil', 
    //'style': 'color:blue;',
    'command': 'foreColor',
    'dropPanel': function(){
        var arr = [],
...
'backgroundColor': {
    ...
    'type': 'dropPanel',
    'cssClass': 'icons-wangEditor-brush',  
    //'style':'color:red;',
    'command': 'backColor ',
    'dropPanel': function(){
        var arr = [],
...
'createLink': {
    ...
    'type': 'modal', 
    'cssClass': 'icons-wangEditor-link',
...
'insertExpression': {
    ...
    'type': 'dropPanel',
    'command': 'insertImage',
    'cssClass': 'icons-wangEditor-happy',
...
'insertVideo': {
    ...
    'type': 'modal',
    'cssClass': 'icons-wangEditor-play',
    'modal': function(editor){
...
'insertTable': {
    ...
    'type': 'modal',
    'cssClass': 'icons-wangEditor-table',
    'modal': function(editor){
...
'insertImage': {
    ...
    'type': 'modal',
    'cssClass': 'icons-wangEditor-picture',
    'modal': function (editor) {
        var //上传组件
...
'insertCode':{
    ...
    'type': 'modal',
    'cssClass': 'icons-wangEditor-terminal',
    'modal': function(editor){
...
'insertLocation':{
    ...
    'type': 'modal',
    'cssClass': 'icons-wangEditor-location',
    'modal': function(editor){
...
'viewSourceCode': {
    ...
    'type': 'modal',
    'cssClass': 'icons-wangEditor-code',
    'modal': function(editor){
        var txtId = $E.getUniqeId(),
            btnId = $E.getUniqeId();
        ...
        $(function(){
            //注意，这是一步特殊处理！！！
            editor.$btnContainer.find('.icons-wangEditor-code') //找到<i>
                                .parent()  //找到 <a> 即 btn
            .click(function(e){
...
'fullScreen': {
    ...
    'type': 'btn',
    'cssClass': 'icons-wangEditor-enlarge2',
    'command': 'fullScreen'
}
		};
	}
	...
	'commandHooks':{
        ...
        'fullScreen': function(commandName, commandValue){
            var $txtContainer = this.$txtContainer,
                ...
                enlargeClass = 'icons-wangEditor-enlarge2',
                shrinkClass = 'icons-wangEditor-shrink2',
